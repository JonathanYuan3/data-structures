...
public class QueueDemo
{
    public static void main(String[] args)
    {
        ...
        * for (int i = 0; i < jobs.size(); i++) { // the size is constantly changing, so set the size beforehand
        *      System.out.println("Printing: " + jobs.remove());
        * }
        */
        
        /*
         for (String job: jobs) { // enhanced for loop doesn't work because the queue changes sizes
